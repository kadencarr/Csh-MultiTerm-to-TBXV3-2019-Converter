...
namespace Csh_mt2tbx
{
    ...
    public class Methods
    {
        ...
        private void modifyTBXHeader(string xcs, string dialect, XmlNode root, string tbxDialect)
        {
        ...
        private void stripForCore(string pathBuilder)
        {
            ...
            if (nodesToRemove.Count > 0)
            {
                ...
                foreach (XmlNode node in nodesToRemove)
                {
                    ...
                    string currentLine = node.Attributes["type"].Value + " discovered! Removing for TBX-Core compliance.";
        ...
        private void stripForMin()
        {
            // To be implemented
        }

        private void stripForBasic()
        {
            // To be implemented
        }
        ...
        private void convertXML(FileStream xmlData, string outputPath, LevelOneClass initialJSON, string tbxOutputDialect, string pathBuilder)
        {
            ...
            using (XmlReader reader = XmlReader.Create(xmlData, readerSettings))
            {
                ...
                modifyTBXHeader(xcs, dialect, root, tbxOutputDialect);
        ...
        public void deserializeFile(string mappingFile, string multiTermXML, string tbxOutputDialect)
        {
